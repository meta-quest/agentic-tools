...
This reference contains ready-to-use SQL queries for common Perfetto trace analysis tasks on Meta VR. All queries use the Perfetto SQL schema and can be executed with `metavr perf query <session-id> "..."`.
